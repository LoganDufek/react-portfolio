...
const Portfolio = () => {
    ...
    const [projects] = useState([
        {
            title: 'Procrast-A-Date', name: 'procrastadate', description: 'MERN/SPA/React', github: 'https://github.com/KevinPMyers/Procrasta-Date', link: 'https://procrasta-date.herokuapp.com/'
        },
        {
